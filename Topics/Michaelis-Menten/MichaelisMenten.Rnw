...
\usepackage[papersize={3in,4in},landscape,margin=.2in]{geometry}
...
Such a complicated curve is \textbf{hard to justify biologiclly}\dots
\end{quote}

\includegraphics[width=.8\textwidth]{WhitlockShluterP489}
\newpage
